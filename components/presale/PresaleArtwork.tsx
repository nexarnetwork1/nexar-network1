    ...
    >
      <div className="absolute inset-0 opacity-[0.04]">
        <svg className="h-full w-full" viewBox="0 0 1200 800" fill="none">
          ...
          <circle cx="980" cy="220" r="90" stroke="#D4AF37" strokeWidth="0.8" opacity="0.5" />
          <circle cx="620" cy="620" r="140" stroke="#D4AF37" strokeWidth="0.8" opacity="0.35" />
          <path d="M120 400 C 300 280, 520 520, 720 360 S 980 460, 1080 320" stroke="#D4AF37" strokeWidth="1.2" />
          <path d="M80 520 C 260 420, 420 640, 640 500 S 920 560, 1120 460" stroke="#D4AF37" strokeWidth="0.8" opacity="0.4" />
        </svg>
      </div>
