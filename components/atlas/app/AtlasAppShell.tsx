...
export function AtlasAppShell({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-[calc(4rem+env(safe-area-inset-bottom))] lg:pb-0">
      <AtlasAppBar />

      <div className="flex">
        <aside className="hidden lg:block w-64 shrink-0 fixed left-0 top-[calc(var(--nxr-nav-height)+var(--nxr-ticker-height)+var(--atlas-app-bar-height))] bottom-0 border-r border-white/10 overflow-y-auto z-10 bg-[#050505]">
          <AtlasLeftSidebar />
        </aside>
        ...
        {!hideRightSidebar && (
          <aside className="hidden xl:block w-80 shrink-0 fixed right-0 top-[calc(var(--nxr-nav-height)+var(--nxr-ticker-height)+var(--atlas-app-bar-height))] bottom-0 border-l border-white/10 overflow-y-auto z-10 bg-[#050505]">
            <AtlasRightSidebar
