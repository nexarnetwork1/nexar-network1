    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5" noValidate>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-gold/35 bg-gold px-4 py-3 text-sm font-semibold tracking-wide text-background shadow-[0_0_30px_-10px_rgba(212,175,55,0.55)] transition-all hover:bg-gold-secondary disabled:opacity-60"
        >
