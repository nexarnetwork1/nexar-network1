...
const bscContracts = getPresaleNetwork("bsc").contracts;

/** Default (BSC) contract addresses — multi-chain list in presale-networks.ts */
export const CONTRACTS = {
  token: bscContracts.token,
  presale: bscContracts.presale,
