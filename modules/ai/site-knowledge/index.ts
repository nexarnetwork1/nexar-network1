...
export const SITE_KNOWLEDGE: SiteKnowledgeEntry[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Shop products", href: MARKETPLACE_ROUTES.shop },
  ...
  },
  {
    ...
    answer:
      "Customers can browse the marketplace, save wishlists, manage cart and checkout, view orders and invoices, connect a wallet, and manage profile settings from the customer dashboard.",
    links: [
      { label: "Marketplace", href: MARKETPLACE_ROUTES.root },
      { label: "Customer dashboard", href: "/customer" },
      { label: "Sign in", href: `${MARKETPLACE_ROUTES.root}?auth=signin` },
    ],
    primaryLink: MARKETPLACE_ROUTES.shop,
  },
  {
    id: "payments",
    title: "Payments",
